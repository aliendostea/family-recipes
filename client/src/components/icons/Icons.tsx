...
export function IconAdd({ height, width, color }: IconProps) {
  const fillColor = color === undefined ? "var(---color-primary)" : color;
...
export function IconPasta({ height, width, color }: IconProps) {
  const fillColor = color === undefined ? "var(---color-primary)" : color;
